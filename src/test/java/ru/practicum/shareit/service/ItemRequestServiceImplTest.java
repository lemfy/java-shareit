...
class ItemRequestServiceImplTest {
    ...
    void addItemRequestByWrongUserReturnUserNotFoundExceptionTest() {
        assertThrows(UserNotFoundException.class, () -> itemRequestService.createRequest(999L, itemRequestDto));
    }
    ...
    void getAllOthersItemRequestsReturnItemRequestsTest() {
        Long otherUserId = userService.createUser(UserDto.builder().name("otherUser").email("otheruser@user.com").build()).getId();
    ...
    void getRequestByIdReturnItemRequestTest() {
        Long requestId = itemRequestService.createRequest(userId, itemRequestDto).getId();
