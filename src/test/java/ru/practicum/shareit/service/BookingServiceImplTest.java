...
class BookingServiceImplTest {
    ...
    void setUp() {
        ...
        ownerId = userService.createUser(userDto).getId();
        bookerId = userService.createUser(UserDto.builder().name("user2").email("user2@test.com").build()).getId();
    ...
    void addNewBookingReturnBookingTest() {
        Integer ownerId = userService.createUser(UserDto.builder().name("user").email("user@user.com").build()).getId();
        Integer bookerId = userService.createUser(UserDto.builder().name("user3").email("user3@test.com").build()).getId();
        Integer itemId = itemService.createItem(ownerId, itemDto).getId();
    ...
    void approveBookingWithWrongBookingIdReturnEntityNotFoundExceptionTest() {
        assertThrows(EntityNotFoundException.class,
                () -> bookingService.approveBooking(ownerId, 999, true));
    }
    ...
    void getBookingByIdWithWrongBookingIdReturnEntityNotFoundExceptionTest() {
        assertThrows(EntityNotFoundException.class,
                () -> bookingService.getBookingById(ownerId, 999));
    }
