...
class BookingServiceImplTest {
    ...
    void addNewBookingReturnBookingTest() {
        Long ownerId = userService.createUser(UserDto.builder().name("user").email("user@user.com").build()).getId();
        Long bookerId = userService.createUser(UserDto.builder().name("user3").email("user3@test.com").build()).getId();
        Long itemId = itemService.createItem(ownerId, itemDto).getId();
