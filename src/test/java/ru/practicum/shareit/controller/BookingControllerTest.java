...
class BookingControllerTest {
    ...
    private final DateTimeFormatter format = DateTimeFormatter.ofPattern(Variables.DT_FORMAT);
    ...
    void addNewBooking() throws Exception {
        ...
        mvc.perform(post("/bookings")
                ...
                .andExpect(jsonPath("$.start", is(bookingResponseDto.getStart().format(format))))
                .andExpect(jsonPath("$.end", is(bookingResponseDto.getEnd().format(format))))
    ...
    void getAllBookings() throws Exception {
        ...
        mvc.perform(get("/bookings")
                ...
                .andExpect(jsonPath("$[0].start", is(bookingResponseDto.getStart().format(format))))
                .andExpect(jsonPath("$[0].end", is(bookingResponseDto.getEnd().format(format))))
