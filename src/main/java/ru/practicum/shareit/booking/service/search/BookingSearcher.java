...
public abstract class BookingSearcher {
    ...
    public abstract List<Booking> findBookings(Integer userId, Pageable pageable);

    public List<Booking> find(BookingRequestStatus status, Integer userId, Pageable pageable) {
